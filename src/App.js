...
// analyse avancée avec l'IA Claude
...
- URLs suspectes: ${localAnalysis.urlSuspects.length}
...
Fournis UNIQUEMENT un objet JSON avec cette structure exacte:
{
  ...
  const formatAnalysisResult = (localAnalysis, aiAnalysis, threatIntelResults) => {
    ...
    if (aiAnalysis) {
      ...
      result += `💡 Analyse: ${aiAnalysis.explanation}\n\n`;
    }
  ...
  return (
    <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
            ...
            <div>
              ...
              <p style={{ margin: '5px 0 0', fontSize: '14px', color: '#666' }}>
                SPF/DKIM/DMARC • VirusTotal • URLhaus • Claude AI
              </p>
            </div>
          </div>
          <button
      ...
      <div style={{
        ...
        🔒 Analyse en temps réel • Aucune donnée stockée • Propulsé par Claude AI + VirusTotal + URLhaus
      </div>
    </div>
  );
};
